...
- Name: e2e.spec.ts >> S03 — Seguridad y Control de Accesos >> 1.3 — Bloquea acceso a /admin/categories sin autenticación
- Location: tests\e2e.spec.ts:37:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/admin/categories
Call log:
  - navigating to "http://localhost:3000/admin/categories", waiting until "load"
