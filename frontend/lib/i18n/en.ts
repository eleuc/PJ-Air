const en = {
  ...
  checkout: {
    ...
    payOnline: 'Immediate Online Payment (Card / Stripe / PayPal)',
    payOnlineDesc: 'Instant processing and faster order production.',
    ...
    transferNoticeTitle: 'Bank Transfer Order Received',
    transferNoticeDesc: 'Your order has been registered. Please complete the bank transfer using the details below. Our team will verify and begin production immediately.',
    transferReferenceLabel: 'Registered Transfer Reference',
    transferPendingApproval: 'Pending Verification by Jhoanes Bakery',
  },
