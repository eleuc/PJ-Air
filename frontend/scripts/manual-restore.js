...
const supabaseUrl = 'https://jdeojeykyapjhvkhrxnc.supabase.co';
const supabaseAnonKey = 'sb_publishable_Uf8u5ScK60j6Xnbv1xB_bQ_aH9tM82R';
...
const PRODUCTS = [
    ...
    { id: 19, name: 'Tiramisú', category: 'Postres', price: 6.50, description: 'Classic Italian dessert made with layers of espresso-soaked sponge cake, silky mascarpone cream, and a light dusting of cocoa powder.', image: '/images/products/Tiramisú.jpg' },
    ...
    { id: 23, name: 'Pear Harmony', category: 'Postres', price: 6.50, description: 'White chocolate mousse with mint and a hint of lemon, filled with pear confiture and pear chunks.', image: '/images/products/Pear Harmony.jpg' },
    ...
    { id: 36, name: 'Piña Colada Dream', category: 'Postres', price: 6.50, description: 'Piña colada mousse with coconut and pineapple confiture infused with rum.', image: '/images/products/Piña Colada Dream.jpg' },
...
async function sync() {
    console.log('Sending products to Supabase...');
