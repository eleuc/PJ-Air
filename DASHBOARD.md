# DASHBOARD — 2.2.11
**Generado**: 2026-07-05T19:58:29.912435
**Profundidad de Sesión**: 🟢 BAJA (6.8%)
**Integridad del Búnker**: 🟢 NOMINAL (98.9%)

## 📊 Métricas Disgregadas
| Métrica | Valor | Umbral | Estado |
| :--- | :--- | :--- | :--- |
| **Profundidad (Odometer)** | 6.8% | ⚠️ 60% / 🔴 80% | 🟢 BAJA |
| **Integridad (Stability)** | 98.9% | 🔴 90% | 🟢 NOMINAL |
| **Deriva (DNA Drift)** | 0.0% | Informativo | ℹ️ Mínima |
| **Densidad (Swelling)** | 3/36 | 🔴 >36 | 🟢 NOMINAL |
| **Turnos Activos** | 72 | — | 🔄 Acumulativo |
| **Carga Volumétrica** | 191.9 KB | 1.9 MB | 📦 Volumétrico |
| **Ventana de Contexto** | 14.4% | ⚠️ 30% / 🔴 70% | 🟢 BAJA |
...
- **Git Trace**: `master` @ `a21934f3` (⚠️ Dirty)
