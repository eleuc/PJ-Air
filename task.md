...
- [x] **TASK-16-06** [BUGFIX/UI-UX] Resolución de condición de carrera (race condition) en CartContext.tsx donde cartKey fluctuaba entre guest y el usuario autenticado, provocando reseteos del carrito local y pérdida de productos añadidos.
